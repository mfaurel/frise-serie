...
- [x] **S02: Horizontal scroll container with yearToPixel width** `risk:medium` `depends:[S01]`
...
- [x] **S03: 3-layer parallax with era nebula backgrounds** `risk:high` `depends:[S02]`
